              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="min-h-screen bg-[#220507] rounded w-full flex flex-col   ">
                    <div className="bg-[#220507] rounded grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-1 gap-3 p-4 items-center justify-center ">
                            ...
                            <div className="relative w-auto sm:w-[260px] lg:w-[260px] h-[380px] rounded-2xl overflow-hidden shadow-lg group">
                               
                                <img src="../src/assets/black.jpg" className=" w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                <div className=" absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent "></div>

                                    <div className="absolute bottom-0 w-full p-4 backdrop-blur-md bg-black/40">
                                        <div>
                                           <h2 className="text-white text-lg font-semibold truncate">name: movie name</h2> 
                                        </div>
                                ...
                                <div className="relative w-[260px] h-[380px] rounded-2xl overflow-hidden shadow-lg group">
                               
                                <img src="../src/assets/A.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/B.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/C.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/E.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/F.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/I.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/G.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/H.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                                ...
                                <img src="../src/assets/J.jpg" className=" relative w-full rounded-2xl h-full object-cover group-hover:scale-110 transition duration-500" alt="" />
                            ...
                            <div className="bg-black h-[300px] w-auto">4</div>
